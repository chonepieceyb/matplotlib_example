...
def draw(): 
    with plt.style.context(styles): 
        ...
        fig, ax1 = plt.subplots(1, 1, sharey=False, gridspec_kw = fig_config['gridspec_kw'])
        set_hatch(**bar_config0["hatch_config"])
        __barcontainer = ax1.bar(x-6*width/5, base_line1_LKM, width, **bar_config0["matplot_config"])
